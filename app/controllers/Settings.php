...
class Settings extends MY_Controller
{
    ...
    function index() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                'site_name' => DEMO ? 'GPOROCASA' : $this->input->post('site_name'),
                ...
                'default_email' => DEMO ? 'miguelito_12jul@hotmail.com' : $this->input->post('default_email'),
