...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="<?= site_url(); ?>" class="logo">
            ...
            <span class="logo-lg"><?= $Settings->site_name == 'TPV' ? '<b>TPV</b>' : '<img src="'.base_url('uploads/logo3.png').'" alt="'.$Settings->site_name.'"  width=200 height=45 />'; ?></span>
        </a>
                        ...
                        <ul class="dropdown-menu" style="padding-right:3px;">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<?= site_url('logout'); ?>" class="btn btn-default btn-flat">Salir</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="mm_welcome"><a href="<?= site_url(); ?>"><i class="fa fa-home"></i> <span><?= lang('dashboard'); ?></span></a></li>
