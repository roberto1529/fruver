...
Debe tener JavaScript habilitado en
                su navegador para utilizar la funcionalidad de este sitio web.</p>
        </div>
    </div>
</noscript>
...
<div>
    <div class="bill" id="bill">
        <div id="product-list">
            <table>
                <tr>
                    <td><h2><b>RESUMEN DE VENTA</b></h2></td>
                </tr>
            </table>
...
<script type="text/javascript">
    ...
    function get(name) {
        if (typeof (Storage) !== "undefined") {
            ...
            alert('Utilice un navegador moderno, ya que este sitio necesita el transporte local!');
        }
    }
