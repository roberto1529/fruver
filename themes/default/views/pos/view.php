    ...
    <div id="receipt-data">
        <div class="text-center">
            ...
            if ($payments) {
                ...
                $ex1 = new QRCodeGenerator('http://localhost/fruver/');
...
<?php } ?>
    ...
    <?php if (!$Settings->java_applet) { ?>
        ...
        <div class="col-xs-12" style="background:#F5F5F5; padding:10px;">
            ...
            <p style="text-transform: capitalize;"><strong>FireFox:</strong> Archivo &gt; Configurar impresora &gt; Margen &amp;Encabezado/Pie de pagina </p>
            <p style="text-transform: capitalize;"><strong>Chrome:</strong> Menu &gt; Impresora &gt; Desabilitar encabezado/Pie de pagina opciones &amp; 
Establecer margen en blanco</p></div>
            <font>
    <?php } ?>
    <div style="clear:both;"></div>
