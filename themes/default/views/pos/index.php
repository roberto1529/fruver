...
<head>
	...
	<link href="<?= $assets ?>bootstrap/css/direccion.css" rel="stylesheet" type="text/css" />
	...
	<div class="wrapper">
		...
		<header class="main-header">
			<a href="<?= site_url(); ?>" class="logo">
				...
				<span class="logo-lg"><?= $Settings->site_name == 'PUNTO VENTA' ? '<b>PUNTO VENTA</b>' : '<img src="'.base_url('assets/uplaods/logo2.png').'" alt="'.$Settings->site_name.'" />'; ?></span>
			</a>
			      ...
			      <div class="left">
			     	 <ul class="nav navbar-nav">
			     	     <li class="hidden-xs hidden-sm"><a href="#" class="clock"></a></li>
			     	      <li class="hidden-xs"><a href="<?= site_url(); ?>"><i class="fa fa-home"></i></a></li>
                    <?php if($Admin) { ?>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				<ul class="sidebar-menu">
					...
					<li id="mm_welcome"><a href="<?= site_url(); ?>"><i class="fa fa-home"></i> <span><?= lang('dashboard'); ?></span></a></li>
											...
											<div id="list-table-div">
												<table id="posTable" class="table table-striped table-condensed table-hover list-table" style="margin:0;">
													<thead>
														<tr class="success">
															<th><?=lang('producto')?></th>
															<th style="width: 15%;text-align:center;"><?=lang('precio')?></th>
															<th style="width: 15%;text-align:center;"><?=lang('qty')?></th>
															<th style="width: 15%;text-align:center;"><?=lang('Presentación')?></th>
